      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          {type === "register" && (
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 bg-zinc-900 border-zinc-800 text-white placeholder:text-zinc-500 focus:border-zinc-600 focus:ring-0 transition-colors"
              />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="h-11 bg-zinc-900 border-zinc-800 text-white placeholder:text-zinc-500 focus:border-zinc-600 focus:ring-0 pr-10 transition-colors"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full h-11 bg-white text-zinc-900 font-medium hover:bg-zinc-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 group"
          >
            {isLoading ? (
              <>
